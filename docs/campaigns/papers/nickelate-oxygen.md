...
<figure markdown>
  ![nickelate-oxygen chart](../../assets/campaigns/nickelate-oxygen.png)
  <figcaption>Projected imaging stays flat; only the depth-resolved method tracks the underlying oxygen disorder.</figcaption>
</figure>
